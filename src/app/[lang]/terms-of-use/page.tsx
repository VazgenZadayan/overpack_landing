...
export default function TermsOfUsePage({ params }: { params: { lang: Locale } }) {
  ...
  const RUContent = () => (
    <div className={styles.termsContent}>
      <h1 className={styles.title}>
        УСЛОВИЯ ИСПОЛЬЗОВАНИЯ ОВЕРПАКА/OVERPACK И/ИЛИ МОБИЛЬНОГО ПРИЛОЖЕНИЯ ЧАСТНОГО ПРЕДПРИНИМАТЕЛЯ &ldquo;ГАГИК БАГДАСАРЯН ГРИГОРЬЕВИЧА&rdquo;
      </h1>
      ...
      <p>Настоящее Пользовательское соглашение заключено между индивидуальным предпринимателем &ldquo;Гагик Багдасарян Григоревич&rdquo; (ИНН - 28345959, адрес - Республика Армения, 0048, город Ереван, Норашен, дом № 11, квартира № 54 ) (далее также именуемым &ldquo;Overpack&rdquo; или &ldquo;Индивидуальный предприниматель&rdquo; или &ldquo;Мобильное приложение&rdquo;) и пользователем (далее также именуемым &ldquo;Пользователь&rdquo;) веб-сайта www.overpack.am и/или мобильного приложения Overpack (в случае совместного наименования веб-сайта и мобильного приложения также именуемого &ldquo;Интернет-магазин&rdquo; или &ldquo;Мобильное приложение&rdquo;), принадлежащих индивидуальному предпринимателю (далее также именуемые &ldquo;Стороны&rdquo;) и определяет условия и порядок приобретения товаров Пользователем посредством мобильного приложения (далее также именуемого &ldquo;Пользовательское соглашение&rdquo;).</p>

      <h2 className={styles.sectionTitle}>I. ОСНОВНЫЕ ПОНЯТИЯ</h2>
      
      <p><strong>1. В настоящем Соглашении следующие термины имеют, помимо прочего, следующие значения:</strong></p>
      <p>а) Интернет-магазин или Мобильное приложение – мобильное приложение Overpack, размещенное в App Store и/или Google Play, принадлежащее Индивидуальному предпринимателю и содержащее ассортимент товаров, предлагаемых Индивидуальным предпринимателем для заказа в режиме онлайн, а также условия доставки, оплаты, возврата и иные условия.</p>
      <p>б) Веб-сайт: Веб-сайт &ldquo;www.overpack.am,&rdquo; расположенный по адресу https://www.overpack.am, принадлежащий Индивидуальному Предпринимателю и предоставляющий информацию о Индивидуальном Предпринимателе, предоставляемых им услугах, а также мобильное приложение Overpack, доступное в App Store и/или Google Play.</p>
      <p>в) Товар: Любой товар, доступный для заказа Пользователем в Интернет-магазине, представленный в Интернет-магазине.</p>
      <p>г) Пользователь: Совершеннолетнее физическое и/или юридическое лицо, имеющее доступ к Интернет-магазину посредством сети Интернет и использующее Интернет-магазин.</p>
      <p>д) Заказ: запрос Пользователя на покупку Товара, представленного в Интернет-магазине и/или Мобильном приложении, который соответствует требованиям использования Мобильного приложения.</p>
      <p>е) Отправитель: Физическое лицо и/или индивидуальный предприниматель и/или его работник, действующий от имени юридического лица, осуществляющий доставку Товара, указанного в Заказе Пользователя, Пользователю или указанному им лицу.</p>

      <h2 className={styles.sectionTitle}>II. ОБЩИЕ ПОЛОЖЕНИЯ</h2>
      
      <p><strong>2.1.</strong> Настоящее Соглашение считается заключенным Пользователем с момента регистрации в Интернет-магазине. Заказывая Товар или Товары через Интернет-магазин, Пользователь соглашается с условиями продажи такого Товара или Товаров, изложенными в настоящем Соглашении.</p>
      
      <p><strong>2.2.</strong> Пользователь обязан ознакомиться с условиями настоящего Соглашения до регистрации в Интернет-магазине. В случае несогласия с условиями настоящего Соглашения Пользователь обязан воздержаться от использования Интернет-магазина.</p>
      
      <p><strong>2.3.</strong> Условия продажи Товара, предусмотренные настоящим Соглашением, а также информация о Товаре, размещенная в Интернет-магазине, являются публичной офертой.</p>
      
      <p><strong>2.4.</strong> Регистрируясь в Интернет-магазине и/или Мобильном приложении и соглашаясь с условиями настоящего Соглашения, Пользователь подтверждает, что приобретает Товар исключительно для личных, семейных, домашних или иных нужд, не связанных с осуществлением предпринимательской деятельности, за исключением случаев, когда Пользователь является юридическим лицом.</p>
      
      <p><strong>2.5.</strong> Если Пользователь является юридическим лицом, то требование, установленное пунктом 2.4 настоящего Соглашения, не применяется.</p>
      
      <p><strong>2.6.</strong> Представленный в Приложении Продукт, который считается табачным изделием в значении Закона РА &ldquo;Об ограничениях на использование, реализацию и потребление табачных изделий&rdquo;, реализуется Индивидуальным предпринимателем исключительно Пользователям, являющимся физическими лицами, достигшими 18 лет.</p>
      
      <p><strong>2.7.</strong> Если Пользователь является физическим лицом, не достигшим 18 лет, он не имеет права приобрести Товар, представленный в Приложении, который считается табачным изделием в понимании Закона РА &ldquo;Об ограничениях на использование, продажу и потребление табачных изделий&rdquo;. Пользователь, являющийся физическим лицом, подтверждает, что на момент оформления Заказа ему исполнилось 18 лет.</p>

      <h2 className={styles.sectionTitle}>III. РЕГИСТРАЦИЯ, РАЗМЕЩЕНИЕ ЗАКАЗА И СРОКИ ВЫПОЛНЕНИЯ</h2>
      
      <p><strong>3.1.</strong> Для оформления Заказа через Интернет-магазин Пользователь должен предварительно зарегистрироваться в Интернет-магазине.</p>
      
      <p><strong>3.2.</strong> При регистрации в Интернет-магазине, помимо иной информации, необходимой Физическому лицу, Пользователь обязан предоставить следующую информацию, а именно:</p>
      
      <p><strong>3.2.1.</strong> Для Пользователя, являющегося физическим лицом:</p>
      <p>- Номер телефона</p>
      <p>- Код отправленный частным предпринимателем по SMS</p>
      <p>- Имя, фамилия</p>
      <p>- Дата рождения</p>
      ...
      <p><strong>3.2.2.</strong> Для Пользователя – юридического лица:</p>
      <p>- номер НДС,</p>
      <p>- номер телефона,</p>
      <p>- код, отправленный ЧП в коротком сообщении (SMS),</p>
      <p>- имя и фамилия уполномоченного лица,</p>
      <p>- данные документа, удостоверяющего личность,</p>
      <p>- Адрес электронной почты,</p>
      <p>- адрес.</p>
      
      <p><strong>3.3.</strong> После регистрации Пользователь выбирает Товар в Интернет-магазине и добавляет его в корзину, указанную в Мобильном приложении для оформления Заказа. Пользователь может самостоятельно удалять и добавлять Товары из корзины до момента подтверждения Заказа.</p>
      
      <p><strong>3.4.</strong> Фотографии, размещенные в интернет-магазине, могут незначительно отличаться от фактического вида Товара. Описания и характеристики Товара не являются исчерпывающими и могут содержать неточности.</p>
      
      <p><strong>3.5.</strong> При выборе желаемого Товара и добавлении его в корзину Пользователь обязан указать адрес доставки.</p>
      
      <p><strong>3.6.</strong> При оформлении Заказа Пользователь обязуется предоставить достоверную и актуальную информацию, необходимую для исполнения Заказа. Индивидуальный предприниматель не несет ответственности за достоверность и актуальность предоставленной Пользователем информации, а также за любые возникшие в связи с этим последствия.</p>
      
      <p><strong>3.7.</strong> После подтверждения Заказа Пользователь не имеет права изменять Товары, указанные в Заказе.</p>
      
      <p><strong>3.8.</strong> При оформлении заказа, помимо иной информации, требуемой Индивидуальным предпринимателем, Пользователь обязан предоставить следующую информацию:</p>
      <p>- срок поставки,</p>
      <p>- полное имя получателя заказа, если получатель не является Пользователем,</p>
      <p>- дополнительный номер телефона (при необходимости),</p>
      <p>- способ оплаты,</p>
      <p>- при оплате бонусной картой — сумма к списанию с бонусной карты,</p>
      <p>- комментарии (при необходимости).</p>
      
      <p><strong>3.9.</strong> Пользователь уведомляется о подтверждении заказа, а также об этапах сбора, доставки, получения на месте и завершения заказа посредством push-уведомлений, отправляемых Частным предприятием.</p>
      
      <p><strong>3.10.</strong> В случае отсутствия добавленного в корзину Товара на складе Индивидуального предпринимателя, Индивидуальный предприниматель уведомляет об этом Пользователя через Интернет-магазин или иным способом.</p>

      <h2 className={styles.sectionTitle}>IV. ПОРЯДОК ОПЛАТЫ</h2>
      
      <p><strong>4.1.</strong> Цена Товара в интернет-магазине указана в драмах РА. Для Пользователя указанная в интернет-магазине цена Товара включает в себя все налоги, предусмотренные законодательством Республики Армения.</p>
      
      <p><strong>4.2.</strong> Общая стоимость Заказа определяется суммой стоимости всех Товаров, добавленных Пользователем в Корзину, а также стоимости упаковки, используемой для их доставки и окончательной упаковки. Стоимость упаковки, используемой для доставки и упаковки заказанных Товаров, может быть также указана в Интернет-магазине.</p>
      
      <p><strong>4.3.</strong> Пользователь может выбрать срок доставки, который не может превышать 1 дня с момента подтверждения Заказа.</p>
      
      <p><strong>4.4.</strong> Индивидуальный предприниматель оставляет за собой право в одностороннем порядке изменять цену Товара до момента подтверждения Заказа Пользователем.</p>
      
      <p><strong>4.5.</strong> Пользователь может оплатить Заказ банковским переводом через платежную систему, доступную в Интернет-магазине.</p>
      
      <p><strong>4.6.</strong> Пользователь имеет право привязать банковскую(ие) карту(ы) к своей персональной странице в Интернет-магазине.</p>
      
      <p><strong>4.7.</strong> Условия оплаты контролируются сторонними банками и платежно-расчетными организациями, с которыми сотрудничает Индивидуальный предприниматель.</p>
      
      <p><strong>4.8.</strong> Выбирая безналичный способ оплаты, Пользователь подтверждает, что он ознакомился и согласен с условиями сторонних банков или платежно-расчетных организаций и не имеет возражений и претензий к Индивидуальному предпринимателю относительно их условий.</p>
      
      <p><strong>4.9.</strong> При выборе безналичного способа оплаты через платёжную систему, доступную в интернет-магазине, Пользователь обязуется оплатить полную сумму, указанную в заказе. В случае неполной оплаты (недостаточной суммы или отсутствия средств) заказ не подтверждается и не обрабатывается в системе. В этом случае с Пользователя не списывается плата.</p>

      <h2 className={styles.sectionTitle}>V. ДОСТАВКА</h2>
      
      <p><strong>5.1.</strong> Товар будет доставлен курьерской службой на территории Республики Армения.</p>
      
      <p><strong>5.2.</strong> Сроки доставки зависят от расстояния и условий дорожного движения.</p>
      
      <p><strong>5.3.</strong> Стоимость доставки включена в общую стоимость заказа.</p>
      
      <p><strong>5.4.</strong> При получении Товара Пользователь обязан проверить соответствие доставленного Товара (количество, качество и т.д.) Заказу только в присутствии курьера.</p>

      <h2 className={styles.sectionTitle}>VI. ПОРЯДОК ОТМЕНЫ И ВОЗВРАТА ЗАКАЗА</h2>
      
      <p><strong>6.1.</strong> Пользователь имеет право отказаться от заказанного Товара до получения push-уведомления о ходе доставки.</p>
      
      <p><strong>6.2.</strong> В случае отказа Пользователя от доставленного Товара Индивидуальный предприниматель вправе удержать стоимость услуг по доставке из перечисленных Пользователем денежных средств. Уплаченная Пользователем сумма за недоставленный Товар подлежит возврату Пользователю в сроки, установленные настоящим Соглашением.</p>
      
      <p><strong>6.3.</strong> Если при получении Заказа Пользователь обнаружил Товар ненадлежащего качества или несоответствие полученного Товара Заказу, Пользователь вправе потребовать замены Товара на Товар надлежащего качества или отказаться от его принятия и потребовать возврата уплаченной за некачественный Товар денежной суммы. Индивидуальный предприниматель обязан заменить Товар в течение одного дня с момента получения запроса Пользователя. Если на момент подачи запроса Индивидуальный предприниматель не может предоставить заменяющий Товар, Индивидуальный предприниматель обязан уведомить Пользователя в течение одного дня с момента отсутствия Товара и возвратить Пользователю уплаченную за не поставленный Товар денежную сумму в сроки, установленные настоящим Соглашением.</p>
      
      <p><strong>6.4.</strong> Если на Товар распространяется гарантийный срок, Пользователь имеет право предъявить претензии, связанные с недостатками Товара, если они обнаружены в течение гарантийного срока.</p>
      
      <p><strong>6.5.</strong> Незначительные отличия в описании, конструкции и/или внешнем виде поставленного Товара от представленного в Интернет-магазине не являются признаком низкого качества.</p>
      
      <p><strong>6.6.</strong> Пользователь не имеет права возврата приобретенных Товаров надлежащего качества, а также Товаров, не подлежащих возврату и/или замене в порядке, установленном Правительством Республики Армения.</p>
      
      <p><strong>6.7.</strong> Пользователь вправе возвратить Индивидуальному предпринимателю непродовольственный Товар надлежащего качества в сроки, установленные законодательством, либо заменить его Товаром других размеров, формы, цвета или аналогичной комплектности, произведя необходимый перерасчет с Индивидуальным предпринимателем в случае возникновения разницы в цене.</p>
      
      <p><strong>6.8.</strong> Товар надлежащего качества возврату не подлежит:</p>
      <p>- если Товар был изготовлен и доставлен в соответствии с конкретными требованиями Пользователя или если Товар является персонализированным;</p>
      <p>- если поставленные Товары подвержены быстрому ухудшению, деградации или изменению качества,</p>
      <p>- В случае продажи запечатанных Товаров, не подлежащих возврату по соображениям гигиены или санитарии, и которые были распечатаны покупателем после доставки;</p>
      <p>- В случае продажи Товаров, которые по своей природе остаются неразрывно связанными после поставки.</p>
      
      <p><strong>6.9.</strong> Требование Пользователя о возврате или замене Товара удовлетворяется, если Товар не был в употреблении, сохранены его потребительские свойства и имеются доказательства приобретения Товара у Индивидуального предпринимателя.</p>
      
      <p><strong>6.10.</strong> Расходы, связанные с возвратом или заменой непродовольственного Товара надлежащего качества, несет Пользователь.</p>
      
      <p><strong>6.11.</strong> В случаях, предусмотренных настоящим Соглашением, требования о возврате уплаченной за Товар денежной суммы подлежат удовлетворению в течение 15 дней с даты предъявления требования.</p>
      
      <p><strong>6.12.</strong> Индивидуальный предприниматель оставляет за собой право отказать в оформлении Заказа через Интернет-магазин, если ранее оформленные Заказы Пользователя не были получены по его вине (например, неоткрытие двери, неответ на звонки курьера при доставке, указание несуществующего адреса доставки и т.п.).</p>

      <h2 className={styles.sectionTitle}>VII. ПРАВА И ОБЯЗАННОСТИ СТОРОН</h2>
      
      <p><strong>7.1.</strong> Частный предприниматель имеет право, в частности:</p>
      <p>- в случае нарушения Пользователем условий настоящего Соглашения ограничить или запретить ему доступ к Интернет-магазину;</p>
      <p>- требовать от Пользователя уплаты установленной суммы за поставленный и принятый товар;</p>
      <p>- Приостанавливать и/или прекращать и/или удалять учетные записи Пользователей за нарушение настоящего Соглашения и/или требований Политики конфиденциальности и/или иных обязательных требований, предусмотренных законодательством;</p>
      <p>- осуществлять иные права, вытекающие из законодательства Республики Армения и Пользовательского соглашения,</p>
      
      <p><strong>7.2.</strong> Частный предприниматель обязан, в частности:</p>
      <p>- Обеспечивать конфиденциальность персональных данных Пользователя в соответствии с условиями &ldquo;Политики конфиденциальности&rdquo;, размещенной на Интернет-магазине;</p>
      <p>- исполнять иные обязательства, вытекающие из законодательства Республики Армения и Пользовательского соглашения.</p>
      
      <p><strong>7.3.</strong> Пользователь имеет право, в частности:</p>
      <p>- После регистрации в Интернет-магазине Вам будет предоставлен доступ к его использованию;</p>
      <p>- пользоваться всеми услугами, доступными в Интернет-магазине, а также приобретать или отказываться от покупки любого товара, предлагаемого в Интернет-магазине;</p>
      <p>- задавать любые вопросы, касающиеся услуг, предоставляемых Индивидуальным предпринимателем через Интернет-магазин, используя любые доступные в Интернет-магазине средства связи;</p>
      <p>- использовать Интернет-магазин исключительно в целях и порядке, предусмотренных Пользовательским соглашением и не запрещенных законодательством Республики Армения;</p>
      <p>- удалять аккаунты в любое время без причинения ущерба Частному Предпринимателю;</p>
      <p>- осуществлять иные права, вытекающие из законодательства Республики Армения и настоящего договора.</p>
      
      <p><strong>7.4.</strong> Пользователь обязуется, в частности:</p>
      <p>- оплатить поставленный товар в порядке, предусмотренном настоящим Соглашением;</p>
      <p>- предоставлять дополнительную информацию, непосредственно связанную с услугами, предоставляемыми Интернет-магазином;</p>
      <p>- уважать имущественные и неимущественные права авторов и иных правообладателей при использовании Интернет-магазина;</p>
      <p>- воздерживаться от действий, которые могут повлиять на нормальную работу Интернет-магазина;</p>
      <p>- воздерживаться от распространения посредством Интернет-магазина конфиденциальной информации, касающейся физических и/или юридических лиц и охраняемой законодательством Республики Армения;</p>
      <p>- Не допускать действий, нарушающих конфиденциальность сведений, охраняемых законодательством Республики Армения;</p>
      <p>- исполнять иные обязанности, вытекающие из законодательства Республики Армения и настоящего Соглашения.</p>
      
      <p><strong>7.5.</strong> Пользователь не имеет права, в частности:</p>
      <p>- Оформить заказ от имени несовершеннолетних;</p>
      <p>- Незаконно приобретать Продукцию, если Пользователь является физическим лицом;</p>
      <p>- Использовать Мобильное приложение любым незаконным или вредоносным образом или нарушать работу Приложения;</p>
      <p>- Предоставлять вводящую в заблуждение информацию физическому лицу или в мобильном приложении.</p>

      <h2 className={styles.sectionTitle}>VIII. АВТОРСКИЕ ПРАВА</h2>
      
      <p><strong>8.1.</strong> Содержание, дизайн, текстовая и графическая составляющие, интерфейсы Интернет-магазина, а также их оформление являются собственностью Частного предпринимателя.</p>
      
      <p><strong>8.2.</strong> Регистрация Пользователя в Интернет-магазине не влечет передачу исключительных прав на результаты интеллектуальной деятельности и средства индивидуализации, принадлежащих Индивидуальному предпринимателю.</p>
      
      <p><strong>8.3.</strong> Использование результатов интеллектуальной деятельности и средств индивидуализации, принадлежащих Индивидуальному предпринимателю, без согласия Индивидуального предпринимателя запрещается.</p>
      
      <p><strong>8.4.</strong> В случае выявления нарушения пункта 8.3 настоящего Соглашения Индивидуальный предприниматель вправе ограничить доступ Пользователя к Интернет-магазину.</p>

      <h2 className={styles.sectionTitle}>IX. ОТВЕТСТВЕННОСТЬ СТОРОН</h2>
      
      <p><strong>9.1.</strong> Индивидуальный предприниматель не несет ответственности за ущерб, причиненный Пользователю в результате ненадлежащего использования товаров, заказанных через Интернет-магазин, в том числе вследствие нарушения условий хранения и/или неправильного оформления заказа, а также некорректно введенных данных.</p>
      
      <p><strong>9.2.</strong> Товар может содержать ингредиенты, способные вызывать аллергические реакции. Заказывая товар в интернет-магазине, Пользователь подтверждает, что ознакомился с составом выбранного товара и не имеет претензий к Компании в связи с этим.</p>
      
      <p><strong>9.3.</strong> Компания не несет ответственности за любой ущерб, понесенный Пользователем в результате неправильного оформления заказа или предоставления неверной информации.</p>
      
      <p><strong>9.4.</strong> Ответственность Индивидуального предпринимателя ограничивается стоимостью последнего Заказа Пользователя.</p>
      
      <p><strong>9.5.</strong> Индивидуальный предприниматель не несет ответственности за косвенные убытки, понесенные Пользователем.</p>

      <h2 className={styles.sectionTitle}>X. ФОРС-МАЖОР</h2>
      
      <p><strong>10.1.</strong> Стороны освобождаются от ответственности за неисполнение или ненадлежащее исполнение своих обязательств по настоящему Договору полностью или частично, если такое неисполнение явилось следствием обстоятельств непреодолимой силы, возникших после вступления в силу настоящего Договора и которые Стороны не могли предвидеть или предотвратить. К таким обстоятельствам относятся: землетрясения, наводнения, пожары, война, военное и чрезвычайное положение, политическая нестабильность, забастовки, перебои в работе связи, действия государственных органов, перебои в электроснабжении, неблагоприятные погодные условия, сбои в работе технических систем, перегрузки и другие обстоятельства, делающие невозможным или существенно затрудняющие исполнение Сторонами своих обязательств по настоящему Договору.</p>
      
      <p><strong>10.2.</strong> В случае возникновения обстоятельств непреодолимой силы сроки исполнения обязательств Сторон отодвигаются соразмерно продолжительности действия таких обстоятельств и их последствий.</p>
      
      <p><strong>10.3.</strong> Сторона, для которой исполнение обязательства стало невозможным или существенно затруднено вследствие действия непреодолимой силы, обязана незамедлительно уведомить об этом другую Сторону.</p>

      <h2 className={styles.sectionTitle}>XI. ПОРЯДОК РАЗРЕШЕНИЯ СПОРОВ</h2>
      
      <p><strong>11.1.</strong> Любые споры, возникающие по настоящему Соглашению, подлежат разрешению путем переговоров.</p>
      
      <p><strong>11.2.</strong> Стороны по взаимному согласию устанавливают досудебный порядок урегулирования споров, возникающих по Пользовательскому соглашению.</p>
      
      <p><strong>11.3.</strong> Сторона, заявляющая о нарушении, обязана подать письменную претензию в досудебном порядке стороне, предположительно допустившей нарушение. В случае неполучения ответа в течение 15 календарных дней со дня получения претензии или отклонения претензии спор может быть передан на рассмотрение в компетентный суд Республики Армения.</p>
      
      <p><strong>11.4.</strong> Применимым правом к Пользовательскому соглашению является законодательство Республики Армения.</p>

      <h2 className={styles.sectionTitle}>XII. ДРУГИЕ ПОЛОЖЕНИЯ</h2>
      
      <p><strong>12.1.</strong> Пользовательское соглашение вступает в силу с момента регистрации Пользователя в Интернет-магазине. Регистрируясь в Интернет-магазине, Пользователь подтверждает, что полностью ознакомился и понимает условия Пользовательского соглашения Интернет-магазина, Политики конфиденциальности индивидуального предпринимателя, а также Правила функционирования системы Интернет-магазина и не имеет к ним никаких возражений.</p>
      
      <p><strong>12.2.</strong> Индивидуальный предприниматель вправе в любое время в одностороннем порядке вносить изменения в Пользовательское соглашение. Новая редакция Соглашения вступает в силу с момента её размещения Индивидуальным предпринимателем в Интернет-магазине. Оформляя каждый заказ в Интернет-магазине, Пользователь подтверждает, что ознакомился и согласен с редакцией Пользовательского соглашения, доступной в Интернет-магазине.</p>
      
      <p><strong>12.3.</strong> Прекращение, аннулирование или недействительность какой-либо части Соглашения не влечет за собой прекращение, аннулирование или недействительность оставшихся частей.</p>
      
      <p><strong>12.4.</strong> К отношениям между Пользователем и Индивидуальным предпринимателем, в частности, применяются положения Гражданского кодекса Республики Армения о розничной торговле и Закона Республики Армения &ldquo;О защите прав потребителей&rdquo;.</p>
      
      <p><strong>12.5.</strong> Настоящее Соглашение составлено на армянском, русском и английском языках и является обязательным для Сторон. В случае расхождений между текстами на армянском, русском и английском языках преимущественную силу имеет армянская версия Пользовательского соглашения.</p>

      <h2 className={styles.sectionTitle}>XIII. ОТКАЗ ОТ ОТВЕТСТВЕННОСТИ</h2>
      
      <p><strong>13.1.</strong> Услуги предоставляются &ldquo;как есть&rdquo;.</p>
      
      <p><strong>13.2.</strong> Overpack не несет ответственности за любые перебои в работе сторонних служб (таких как банки или курьерские службы).</p>
      
      <p><strong>13.3.</strong> Бесперебойный доступ не гарантируется.</p>

      <h2 className={styles.sectionTitle}>XIV. СОБЛЮДЕНИЕ ПРАВИЛ ПЛАТФОРМЫ</h2>
      
      <p><strong>14.1.</strong> Overpack соответствует политикам Google Play (включая ограничения по безопасности данных и использованию табачных изделий).</p>
      
      <p><strong>14.2.</strong> Приложение Overpack соответствует политикам App Store компании Apple (включая политику отзывов, правила конфиденциальности и информацию о пищевой ценности).</p>
      
      <p><strong>14.3.</strong> Все описания, скриншоты и рекламные объявления точно отражают функциональность приложения.</p>

      <h2 className={styles.sectionTitle}>XV. ОТКАЗ ОТ ОТВЕТСТВЕННОСТИ ЗА ТАБАЧНЫЕ ИЗДЕЛИЯ</h2>
      <p><strong>Юридическая информация о табаке</strong></p>
      
      <p><strong>15.1.</strong> Приложение не рекламирует и не поощряет употребление кальяна.</p>
      
      <p><strong>15.2.</strong> Не делается никаких заявлений, которые могли бы указывать на социальную, психологическую или медицинскую пользу.</p>
      
      <p><strong>15.3.</strong> В соответствии с законодательством Республики Армения:</p>
